...
_SYSTEM = (
    ...
    "ContainerForgeEnv (via the base class) satisfies forge.contracts.Environment: the seven\n"
    "required members task_source, initial_state, observations, backend, state, rubric, and\n"
    "termination, each a property returning the concern of the same name (TaskSource,\n"
