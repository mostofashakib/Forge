...
_CUSTOM_STUBS = {
    ...
    "config.yaml": (
        ...
        "  hidden_entities: []\n"
        "\n"
        "# Simulated people who share this environment with the agent. Edit them\n"
        "# here, or visually at /environments/<name>/personas.\n"
        "#\n"
        "# Who exists and when they act is fixed by the episode seed. What they do\n"
        "# each turn is chosen by `driver`, and is bounded by `allowed_actions` —\n"
        "# a persona can never take an action not listed there.\n"
        "personas:\n"
        "  enabled: false\n"
        "  driver: scripted        # or an agent id, e.g. anthropic:claude-sonnet-5\n"
        "  max_actions_per_step: 1\n"
        "  roster: []\n"
        "#  roster:\n"
        "#    - archetype: meticulous_nurse   # see forge/personas/archetypes.py\n"
        "#      id: nurse_priya\n"
        "#      behavior:\n"
