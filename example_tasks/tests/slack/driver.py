"""Slack simulation driver entrypoint."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run deterministic Slack simulations.")
    parser.add_argument("--seed", type=int, default=1)
    parser.add_argument("--tasks", help="Path to a JSON list of Slack task definitions.")
    parser.add_argument("--output", default="/tmp/fleet/slack_trajectory.json")
    ...
    tasks = load_tasks(args.tasks, "slack") if args.tasks else [builtin_slack_incident_task()]
